/*
 * PostHog analytics — ported verbatim from the previous Stainless docs
 * (../overmind-lab-api-docs/astro.config.ts head script).
 *
 * Mintlify auto-includes any .js file in the content directory on every page,
 * running it after the page becomes interactive. We use the raw snippet (rather
 * than Mintlify's native integrations.posthog) so the full init options —
 * ui_host, defaults, person_profiles — are preserved exactly as before.
 */
...
posthog.init('phc_XrIVhixaz5sOqrdzpRwwqlvKXilmcy3PWPgdk0pemZa', {
  api_host: 'https://v.overmindlab.ai', // your managed reverse proxy domain
