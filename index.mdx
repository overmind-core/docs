...
Improvements always end in a review — an observability PR, an optimization PR, a model-swap PR — never in Overmind silently changing what you ship.
...
<CardGroup cols={3}>
  <Card title="Agents" href="/core/agents" icon="robot">
    The working model of each agent in your code — structure, behavior, and everything attached to it.
  </Card>
