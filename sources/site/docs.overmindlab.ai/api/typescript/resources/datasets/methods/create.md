# Source: https://docs.overmindlab.ai/api/typescript/resources/datasets/methods/create
...
body: DatasetCreateParams { agent, datapoints, generator\_model, 5 more }
...
DatasetCreateResponse { id, agent, created\_at, 8 more }
