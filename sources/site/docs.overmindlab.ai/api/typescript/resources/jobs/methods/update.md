# Source: https://docs.overmindlab.ai/api/typescript/resources/jobs/methods/update
...
body: JobUpdateParams { agent, analyzer\_model, backtest\_results, 15 more }
...
JobUpdateResponse { id, created\_at, iterations, 19 more }
