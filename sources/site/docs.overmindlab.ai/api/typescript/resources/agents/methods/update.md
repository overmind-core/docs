# Source: https://docs.overmindlab.ai/api/typescript/resources/agents/methods/update
...
body: AgentUpdateParams { active\_dataset, agent\_description, agent\_path, 33 more }
...
AgentUpdateResponse { id, created\_at, name, 36 more }
