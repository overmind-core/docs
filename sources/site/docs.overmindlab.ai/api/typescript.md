# Source: https://docs.overmindlab.ai/api/typescript

[Overview](https://docs.overmindlab.ai/api/typescript)
...
# Overmind Lab TypeScript API Library

# Overmind Lab TypeScript API Library

[![NPM version](https://img.shields.io/npm/v/overmind-lab.svg?label=npm%20(stable))](https://npmjs.org/package/overmind-lab) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/overmind-lab)

This library provides convenient access to the Overmind Lab REST API from server-side TypeScript or JavaScript.

The full API of this library can be found in [api.md](https://github.com/stainless-sdks/overmind-lab-typescript/tree/main/api.md).
...
Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install overmind-lab`
...
await client.agents.create({ name: 'x', project: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', slug: 'slug' }, {
  maxRetries: 5,
});
```
...
Note that requests which time out will be [retried twice by default](https://github.com/stainless-sdks/overmind-lab-typescript/tree/main/#retries).
...
1. Via the `OVERMIND_LAB_LOG` environment variable
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/overmind-lab-typescript/issues) with questions, bugs, or suggestions.
...
See [the contributing documentation](https://github.com/stainless-sdks/overmind-lab-typescript/tree/main/./CONTRIBUTING.md).