# Source: https://docs.overmindlab.ai/api/python/resources/job_iterations/methods/create
...
dimension\_scores: Optional\[[object](https://docs.overmindlab.ai/api/python/resources/job_iterations/methods/create#(resource)%20job_iterations%20%3E%20(method)%20create%20%3E%20(params)%20default%20%3E%20(param)%20dimension_scores%20%3E%20(schema))\]
...
class JobIterationCreateResponse: …
...
client = OvermindLab()
job_iteration = client.job_iterations.create(
    iteration_name="x",
