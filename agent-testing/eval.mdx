...
Runs move through pending, running, and completed states, can be canceled mid-flight, and show live progress while running: per-variant generation progress, scores so far, errors so far, and the latest responses streaming in as they're produced.
