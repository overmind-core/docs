...
You also set a **run budget**: how many optimisation iterations, and how many candidates per iteration. The defaults are five iterations of three candidates, stopping early after three iterations without improvement, which balances thoroughness against time and cost.
