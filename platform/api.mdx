...
| Datasets | `/api/datasets/` | read, rename and delete; `POST .../remove_datapoints/`, `POST .../activate/`, `GET .../cards/`, `GET .../eval-capabilities/`, `GET .../datapoints/`, the `/workshop/` family |
...
| Resource | Base path | Custom actions |
| --- | --- | --- |
| Evaluators | `/api/evaluators/` | `GET catalog/`, `GET score-history/`, `POST author/` |
| Eval sets | `/api/eval-sets/` | `.../members/`, `POST .../activate/` |
| Eval runs | `/api/eval-runs/` | `POST .../run/`, `POST .../cancel/`, `GET .../comparison/` |
...
| Deployed models | `/api/deployed-models/` | `POST .../deploy/`, `POST .../undeploy/`, `POST .../retry/`, `GET .../metrics/`, `GET .../activity/`, `GET .../checkpoints/` |
