...
<Steps>
  ...
  <Step title="Copy the onboarding prompt">
    The **Agent** page opens empty. Pick your coding agent — **Cursor**, **Claude Code**, **OpenCode**, or **Codex** — and hit **Copy onboarding prompt**.
  </Step>
  <Step title="Paste it into your coding agent">
    Paste the prompt into your coding agent (repo root as the workspace folder) and submit.
